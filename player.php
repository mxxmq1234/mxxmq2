  ...
  <head>
    ...
    <style>
      ...
      [aria-label='Play'][type='button']::before {
        ...
        height: 4rem;
        display: block;
        /* filter: drop-shadow(0 10px 8px rgb(150 0 0 / 0.04)) drop-shadow(0 4px 3px rgb(150 0 0 / 0.1)); */
        position: absolute;
        top: 50%;
        left: 50%;
  ...
  <body>
    ...
    <script>
      ...
      if (_query.startsWith('http')) {
        ...
        title = safeDecodeURIComponent(search.get('title')) || 'İngSport TV'
      ...
      if (title && title != 'İngSport TV') document.title = title
